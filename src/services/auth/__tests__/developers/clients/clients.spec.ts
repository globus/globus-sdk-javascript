...
describe('clients', () => {
  ...
  describe('next', () => {
    test('get', async () => {
      const result = await developers.clients.next.get({
        client_id: '6521a0c3-ffc9-4432-9cb6-41fa8fe2e4e9',
      });
      const {
        req: { url, method, headers },
      } = await mirror(result);
    ...
    test('getAll', async () => {
      const result = await developers.clients.next.getAll({
        request: { query: { fqdn: 'www.test.com' } },
      });
      const {
        req: { url, method, headers },
      } = await mirror(result);
    ...
    test('create', async () => {
      const {
        ...
        await developers.clients.next.create({
          request: {
            data: {
              name: 'My Test Client',
              public_client: true,
    ...
    test('createNativeApp', async () => {
      const {
        ...
        await developers.clients.next.createNativeApp({
          request: {
            data: {
              name: 'My Native App',
              template_id: 'test-native-template-id',
    ...
    test('update', async () => {
      const {
        ...
        await developers.clients.next.update({
          client_id: '6521a0c3-ffc9-4432-9cb6-41fa8fe2e4e9',
          request: {
            data: {
              name: 'Updated Client Name',
    ...
    test('remove', async () => {
      const {
        ...
        await developers.clients.next.remove({
          client_id: '6521a0c3-ffc9-4432-9cb6-41fa8fe2e4e9',
        }),
      );
      expect({
